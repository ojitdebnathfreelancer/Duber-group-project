                ...
                <div className="grid lg:max-w-7xl md:max-w-md gap-4 md:grid-cols-2 lg:grid-cols-3 mx-auto">
                    ...
                    <div className="max-w-md  rounded-xl bg-white shadow-lg">
                        ...
                        <div className="flex flex-col items-center gap-6 p-8">
                            ...
                            <button className="mt-3 w-full rounded-lg bg-[#1c1470] p-3 text-sm font-semibold text-white shadow-xl shadow-blue-700/30 outline-none transition-transform hover:scale-105 hover:bg-[#332c84] focus:scale-105 focus:bg-blue-600 focus:ring-2">Proceed to Booking</button>
                        </div>
                    </div>
                    {/* <!-- Card Starts Here --> */}
                    <div className="max-w-md rounded-xl bg-white shadow-lg">
