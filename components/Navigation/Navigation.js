...
const Navigation = () => {
  ...
  const menuItems = <>
    <li className="mr-5 flex items-center">
      <Link className="hover:bg-[#333333] px-4 py-2 rounded-2xl duration-150" href="/about">Company</Link>
    </li>
    <li className="mr-5 flex items-center">
      <Link className="hover:bg-[#333333] px-4 py-2 rounded-2xl duration-150" href="/">Sefty</Link>
    </li>
    <li className="mr-5 flex items-center">
      <Link className="hover:bg-[#333333] px-4 py-2 rounded-2xl duration-150" href="/">Help</Link>
    </li>
  </>
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center px-2 text-white h-[70px]">
        ...
        <div className="flex items-center">
          ...
          <button onClick={() => setOpen(!open)} className='hover:bg-[#333333] p-2 rounded-[50%] duration-150 text-white font-bold lg:hidden block'>
            {
              open ?
                <RxCross2 className="text-white font-bold lg:hidden block" size={25} />
                :
                <HiBars2 className="text-white font-bold lg:hidden block" size={25} />
            }
          </button>
        </div>
        <div className={` ${styles.phoneNav} ${open ? styles.phoneDisplay : ''}`} >
          ...
          <button className="lg:mr-5 mr-4 text-[16px] w-full bg-[#EEEEEE] px-4 py-2 rounded-[5px] mt-20 duration-150">Products</button>
